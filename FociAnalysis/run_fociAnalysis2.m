function run_fociAnalysis2(dirname,paramFit,timeStep,Dparameter,exp_cut,noiseTh)
...
%     noiseTh = str2num(answer{1});
    ...
    length_function(stackname,kymofolder,gc_fitfolder,kmeansfolder,fociresfolder,Ncell,frame,limits,paramFit,timeStep,Dparameter,exp_cut,8);
      
end

%name_noise=[dirname,'noiseTh_params.mat'];
%save(name_noise,'noiseTh_all');
