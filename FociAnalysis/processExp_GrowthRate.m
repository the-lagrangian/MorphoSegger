...
function processExp_glycerol_GrowthRate(preprocess,naming,supersegger,cleanup,imag2stack,morpho,fociCalc)
...
if preprocess  
    ...
    macroFile1='ConvertND2toTif_phase.txt';
...
if imag2stack   
    ...
    macroFile2='tifImagesToStack_phase.txt';
...
if fociCalc
    ...
    run_fociAnalysis(dirname,paramFit,2,Dparameter,exp_cut,noiseTh)
